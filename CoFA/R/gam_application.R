...
#' @param model_num A numeric vector of the model numbers which can be positive integers from 1 to 9
...
gam_application <- function(which_ear = "right", model_num = 1:9 ){
...
for(i in 1:len_results_list){
  cat(i, "th iteration for one specified knot setting in data_application function \n")
  ...
  ########################################################################################################
  ### End of estimation for the given models

#' Fast Covariance Estimation function adjusted for CoFA based on the function in the refund R package
#' The only change is that the adjusted function takes the same knots used in CoFA
#'

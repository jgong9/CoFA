#' Smooth covariance function estimation from fpca.sc of refund
#' The only change is that the modified function returns the estimated covariance function as cov.hat
#' @noRd
#' @importFrom Matrix nearPD Matrix t as.matrix
#' @importFrom mgcv gam predict.gam
#' @importFrom gamm4 gamm4
fpca_sc_modified <- function(Y = NULL, ydata = NULL, Y.pred = NULL, argvals = NULL, random.int = FALSE,
